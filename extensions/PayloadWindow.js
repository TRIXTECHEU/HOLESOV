...
(function (window, document) {
  ...
  var SS = {
    SUPPRESS: 'holesov_payload_suppressed_session',
    PAYLOAD_DISMISSED: 'holesov_payload_dismissed_by_user',
    CHAT_OPEN: 'holesov_chat_is_open',
    USER_OPENED_CHAT: 'holesov_user_opened_chat',
    CHAT_CLOSED_TIME: 'holesov_chat_closed_time',
    SHOW_COUNT: 'holesov_show_count',
    LAST_SHOW_TIME: 'holesov_last_show_time',
    SESSION_START: 'holesov_session_start'
  };

  var LS = {
    LAST_CLOSE: 'holesov_last_close_at',
    TOTAL_VISITS: 'holesov_total_visits',
    LAST_VISIT: 'holesov_last_visit'
  };
...
:root{
  ...
  --holesov-launcher-size:120px;
  --holesov-font: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
}
...
#holesov-cta.holesov-cta.is-out{ 
  opacity: 0 !important; 
  transform: translateY(8px) scale(.98) !important; 
  visibility: hidden !important; 
  pointer-events: none !important; 
...
#holesov-cta .holesov-title-rest{ 
  color: #0b1720 !important; 
}

#holesov-cta .holesov-desc{ 
...
#holesov-cta #holesov-open.holesov-btn{
  position: relative !important;
  overflow: hidden !important;
...
#holesov-cta #holesov-open.holesov-btn:active{ 
...
#holesov-cta .holesov-avatar, 
#holesov-cta .holesov-btn, 
#holesov-cta .holesov-close, 
#holesov-cta .holesov-card, 
#holesov-cta .holesov-cta, 
#holesov-cta img{ 
  -webkit-user-drag: none !important; 
...
@media (max-width:768px){
  ...
  #holesov-cta .holesov-title{ font-size: 14px !important; }
  #holesov-cta .holesov-desc{ font-size: 13px !important; }
  #holesov-cta #holesov-open.holesov-btn{ 
...
@media (max-width:480px){
  ...
  #holesov-cta .holesov-title{ font-size: 13px !important; }
  #holesov-cta .holesov-desc{ font-size: 12.5px !important; line-height: 1.4 !important; }
  #holesov-cta #holesov-open.holesov-btn{ 
  ...
  function injectCTA() {
    if (document.getElementById('holesov-cta')) return;
    ...
    wrap.innerHTML = [
      '<div class="holesov-cta" id="holesov-cta" aria-live="polite" aria-hidden="true" style="display:none">',
      ...
      '    <button id="holesov-open" class="holesov-btn" aria-label="Otevřít AI asistenta Holešov"><span class="holesov-label">Poraď mi</span></button>',
      '  </div>',
      '</div>'
    ].join('\n');
  ...
  function bindOpenChatButton() {
    var btn = document.getElementById('holesov-open');
    if (btn) {
  ...
  function bindCTA() {
    ctaEl = document.getElementById('holesov-cta');
    btnOpenEl = document.getElementById('holesov-open');
    btnCloseEl = document.getElementById('holesov-close');
    descEl = document.getElementById('holesov-text');
